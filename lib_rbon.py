...
def uncurry(f):  #4 (line num in coconut source)
    @_coconut_tco  #4 (line num in coconut source)
    @_coconut_mark_as_match  #4 (line num in coconut source)
    def g(*_coconut_match_args, **_coconut_match_kwargs):  #4 (line num in coconut source)
        _coconut_match_check_0 = False  #4 (line num in coconut source)
        _coconut_match_set_name_f = _coconut_sentinel  #4 (line num in coconut source)
        _coconut_match_set_name_x = _coconut_sentinel  #4 (line num in coconut source)
        _coconut_match_set_name_y = _coconut_sentinel  #4 (line num in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #4 (line num in coconut source)
        if (_coconut.len(_coconut_match_args) == 2) and ("f" not in _coconut_match_kwargs) and (_coconut.isinstance(_coconut_match_args[1], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_args[1]) == 2):  #4 (line num in coconut source)
            _coconut_match_temp_0 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("f")  #4 (line num in coconut source)
            _coconut_match_set_name_x = _coconut_match_args[1][0]  #4 (line num in coconut source)
            _coconut_match_set_name_y = _coconut_match_args[1][1]  #4 (line num in coconut source)
            if not _coconut_match_kwargs:  #4 (line num in coconut source)
                _coconut_match_set_name_f = _coconut_match_temp_0  #4 (line num in coconut source)
                _coconut_match_check_0 = True  #4 (line num in coconut source)
        if _coconut_match_check_0:  #4 (line num in coconut source)
            if _coconut_match_set_name_f is not _coconut_sentinel:  #4 (line num in coconut source)
                f = _coconut_match_temp_0  #4 (line num in coconut source)
            if _coconut_match_set_name_x is not _coconut_sentinel:  #4 (line num in coconut source)
                x = _coconut_match_args[1][0]  #4 (line num in coconut source)
            if _coconut_match_set_name_y is not _coconut_sentinel:  #4 (line num in coconut source)
                y = _coconut_match_args[1][1]  #4 (line num in coconut source)
        if not _coconut_match_check_0:  #4 (line num in coconut source)
            raise _coconut_FunctionMatchError('def g(f, [x,y]) = (x, y) |*> f', _coconut_match_args)  #4 (line num in coconut source)

        return _coconut_tail_call((f), *(x, y))  #5 (line num in coconut source)

    return _coconut_tail_call(_coconut.functools.partial(_coconut.functools.partial, g), f)  #7 (line num in coconut source)
split = (flip)(str.split)  #7 (line num in coconut source)
curry = _coconut.functools.partial  #8 (line num in coconut source)
